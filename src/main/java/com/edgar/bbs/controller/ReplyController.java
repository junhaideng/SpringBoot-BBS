...
public class ReplyController {
    ...
    public Result starReply(HttpSession session, @RequestParam("id") Long id, @RequestParam("type") String type, @RequestParam("url") String url) {
        ...
        if (type.equals("like")) {
            ...
            messageDao.insert(reply.get().getReply(), String.format("%s点赞了你的回复", username), reply.get().getUsername(), "点赞", url);
